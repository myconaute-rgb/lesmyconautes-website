...
export const AGRI_SPECIES: AgriSpecies[] = [
  {
    ...
    blurb: "Grande tolérance aux aléas de culture. Bonne espèce pour démarrer. Entailler le sac, maintenir humide — ça pousse vite.",
  ...
  },
  {
    ...
    blurb: "Chair ferme et délicieuse, conservation longue. Cycle court, tolérance faible. Sensible aux bactéries — salles propres indispensables.",
  ...
  },
  {
    ...
    blurb: "Crinière de lion. Champignon d'exception à portée de culture. Besoin d'air frais, ne tolère pas les espaces confinés. Rendement ~15%.",
  ...
  },
  {
    ...
    blurb: "Chair moelleuse et parfum boisé. Connu en médecine asiatique et des palais du monde entier. Conservation aisée.",
